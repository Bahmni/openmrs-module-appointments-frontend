...
export const personUrl = reactConfig["personUrl"];
...
export const searchAppointmentsUrl = reactConfig["searchAppointmentsUrl"];
export const conceptUrl  = reactConfig["conceptUrl"];
