        ...
        <FocusLock>
            <div className={classNames(updateConfirmationModal)}>
                <div className={classNames(updateConfirmationModalCloseIcon)}>
                    <button data-testid="update-confirmation-close-icon" tabIndex={3}>
                        <i className={classNames("fa", "fa-times")} onClick={() => {
                            close();
                        }}/>
                    </button>
                </div>
                <div>
                    ...
                    <div>
                        ...
                        <button className={classNames(button)} data-testid="update-confirm-button" onClick={save} tabIndex={2}>
