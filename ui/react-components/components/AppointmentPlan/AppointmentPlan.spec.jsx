...
describe('Recurring plan', () => {
    it('should render the Recurring plan component', () => {
        const {container, getByText} = renderWithReactIntl(<AppointmentPlan onChange={jest.fn()} isRecurring={false}/>);
    ...
    it('should call onChange on click of checkbox', () => {
        ...
        const {container, getByText} = renderWithReactIntl(<AppointmentPlan onChange={onChangeSpy} isRecurring={false}/>);
    ...
    it('should disable the checkbox when isEdit is true', () => {
        const {container} = renderWithReactIntl(<AppointmentPlan isEdit={true} isRecurring={true}/>);
