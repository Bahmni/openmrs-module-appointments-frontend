...
test('renders ListView with no appointments correctly', () => {
    const tree = renderer
        .create(<ListView />)
        .toJSON()
...
test('renders ListView with appointments correctly', () => {
    const tree = renderer
        .create(<ListView columns={columns} rows={rows} />)
        .toJSON()

    expect(tree).toMatchSnapshot()
})

test('should sort records ascending wrt column and display icon on click of column header', () => {
...
test('should sort records descending wrt column and display icon on click of column header', () => {
    rows[0]["Patient Name"] = "Antony"
    rows[1]["Patient Name"] = "Zenia"
    rows[2]["Patient Name"] = "Ramesh"
...
test('should sort records in descending if previous column based sorting was descending', () => {
