...
import {getRecurringAppointment, recurringConflictsFor, saveRecurringAppointments, updateRecurringAppointments} from "./recurringAppointmentsApi";
...
describe('Recurring Appointments Api', () => {
    ...
    let updatePayload = {
        ...
        "appointmentRequest": {
            ...
            "locationUuid": "8debb630-20e0-11e7-a53f-000c29e530d2",
            "appointmentKind": "Scheduled",
            "uuid": "d5e9bc86-8b61-4b53-b112-d633d5c904ed"
        },
        "recurringPattern": {
            "frequency": 2,
            "type": "DAY",
  ...
  it('should get conflicting appointments for recurring appointment request', async () => {
    ...
    it('should update recurring appointments and get saved appointments as response', async () => {
        ...
        let appointment = await updateRecurringAppointments(updatePayload);

        let appointmentUuid = "d5e9bc86-8b61-4b53-b112-d633d5c904ed";
        expect(mockAxios.put).toHaveBeenCalledWith(`${recurringAppointmentsSaveUrl}/${appointmentUuid}`, updatePayload);
