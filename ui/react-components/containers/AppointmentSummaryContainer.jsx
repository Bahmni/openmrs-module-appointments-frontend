...
import GridSummary from "../components/GridSummary/GridSummary.jsx";
...
import {getAppointmentSummary} from "../api/appointmentsApi";
        ...
        return (
            <AppContext.Provider value={{ goToListView, setStartDate, setEndDate, state, startDate, endDate }}>
                <IntlProvider defaultLocale='en' locale={locale} messages={messages}>
                    ...
                    <h3>Specialties</h3>
                    <GridSummary gridData={data} weekStartDate={startDate} onClick={goToListView} filterBy={'speciality'}/>
                    <h3>Services</h3>
                    <GridSummary gridData={data} weekStartDate={startDate} onClick={goToListView}/>
                    <h3>Providers</h3>
                    <GridSummary gridData={data} weekStartDate={startDate} onClick={goToListView}/>
                    <h3>Locations</h3>
                    <GridSummary gridData={data} weekStartDate={startDate} onClick={goToListView} filterBy={'location'}/>
                </IntlProvider>
            </AppContext.Provider>);
    }
}
