describe('AppointmentStatusHandler#getUpdatedStatusAndProviderResponse', function () {
    ...
    describe('Edit Scenario', function () {
        it('should keep the existing status of appointment if initial status is scheduled', function () {
            ...
            const updatedStatusAndProviderResponse = Bahmni.Appointments.AppointmentStatusHandler.getUpdatedStatusAndProviderResponse(appointment, currentProviderUuid, ['xyz1']);
        ...
        it('should set the status as Scheduled when current user gets added to a existing requested appointment', function () {
            ...
            const updatedStatusAndProviderResponse = Bahmni.Appointments.AppointmentStatusHandler.getUpdatedStatusAndProviderResponse(appointment, currentProviderUuid, ['xyz1', 'xyz3']);
        ...
        it('should change status to requested if providers removes self and no other providers are accepted', function () {
            ...
            const updatedStatusAndProviderResponse = Bahmni.Appointments.AppointmentStatusHandler.getUpdatedStatusAndProviderResponse(appointment, currentProviderUuid, ['xyz1','xyz2','xyz3']);
    ...
    describe('Reschedule Scenario', function () {
        it('should change the status to requested and provider response to AWAITING when rescheduled', function () {
            ...
            const updatedStatusAndProviderResponse = Bahmni.Appointments.AppointmentStatusHandler.getUpdatedStatusAndProviderResponse(appointment, currentProviderUuid, ['xyz1'], true);
        ...
        it('should change the status to scheduled and current provider response to ACCEPTED when rescheduled is done by participant', function () {
            ...
            const updatedStatusAndProviderResponse = Bahmni.Appointments.AppointmentStatusHandler.getUpdatedStatusAndProviderResponse(appointment, currentProviderUuid, [], true);
